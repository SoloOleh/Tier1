...
# Створення об'єкту "Figure" для 3D графіку
fig = go.Figure()

# Додавання векторів до графіку
...
fig.update_layout(title='Компланарні вектори, що лежать в площині та нормаль до площини')
